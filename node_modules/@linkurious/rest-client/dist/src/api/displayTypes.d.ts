...
export declare type ItemSelector = SelectorAny | SelectorIs | SelectorNoValue | SelectorNaN | SelectorRange;
...
export declare enum OgmaNodeShape {
    CIRCLE = "circle",
    CROSS = "cross",
    DIAMOND = "diamond",
    PENTAGON = "pentagon",
...
export declare enum OgmaEdgeShape {
    LINE = "line",
    ARROW = "arrow",
    TAPERED = "tapered",
    DASHED = "dashed",
