...
export declare enum AlertColumnType {
    STRING = "string",
    NUMBER = "number"
}
...
export declare type AlertTree = Tree<Alert, 'alert'>;
...
export declare enum GetMatchesSortDirection {
    ASC = "asc",
    DESC = "desc"
}
export declare enum GetMatchesSortBy {
    DATE = "date",
    ZERO = "0",
    ONE = "1",
    TWO = "2",
...
export declare type AlertPreview = Array<{
    nodes: LkNode[];
    edges: LkEdge[];
