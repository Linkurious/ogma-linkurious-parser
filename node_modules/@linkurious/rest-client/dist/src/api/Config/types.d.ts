...
export declare type SelectedDataSourceConfig = IDataSourceConfig<INeo4jConfig, INeo4jSearchConfig> | IDataSourceConfig<INeo4jConfig, InternalIndexConfig> | IDataSourceConfig<INeo4jConfig, INeo2esConfig> | IDataSourceConfig<IJanusGraphConfig, IJanusGraphSearchConfig> | IDataSourceConfig<IJanusGraphConfig, InternalIndexConfig> | IDataSourceConfig<ICosmosDbConfig, IAzureSearchConfig> | IDataSourceConfig<ICosmosDbConfig, InternalIndexConfig> | IDataSourceConfig<IJanusGraphForComposeConfig, IJanusGraphSearchConfig> | IDataSourceConfig<IJanusGraphForComposeConfig, InternalIndexConfig>;
...
export declare type InternalIndexConfig = IElasticSearchConfig | IElasticSearch2Config;
...
export declare enum DefaultPage {
    DASHBOARD = "dashboard",
    WORKSPACE = "workspace"
}
...
export declare type IUpdateConfigParams<T = unknown> = IResetConfigParams | IDataSourceConfigParams | IConfigurationParams<T>;
