...
export declare enum CustomActionType {
    NON_GRAPH = "non-graph",
    NODE = "node",
    EDGE = "edge",
    NODESET = "nodeset",
...
export declare enum CustomActionVariable {
    BASE_URL = "baseurl",
...
export declare type CustomActionElement = {
    value: string;
    type: 'ca-literal';
} | {
    value: string;
    type: 'ca-expression';
    variable: CustomActionVariable.VISUALIZATION | CustomActionVariable.SOURCE_KEY | CustomActionVariable.BASE_URL;
} | {
    value: string;
    type: 'ca-expression';
...
export declare enum CustomActionSharingMode {
    PRIVATE = "private",
    SOURCE = "source"
}
export declare enum CustomActionRight {
    OWNER = "owner",
    READ = "read"
}
export declare enum CustomActionParsingErrorKey {
...
export declare type CustomActionParsingError = {
    start: number;
    end: number;
} & ({
    ...
    key: Exclude<CustomActionParsingErrorKey, CustomActionParsingErrorKey.INVALID_SEMANTIC | CustomActionParsingErrorKey.INCOMPATIBLE_RESTRICTIONS | CustomActionParsingErrorKey.INVALID_TEMPLATE_COMBINATION>;
});
