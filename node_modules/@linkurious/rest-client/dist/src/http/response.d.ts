...
export declare enum LkErrorKey {
...
export declare class Response<B> {
    ...
    isSuccess(): this is Exclude<this, Response<LkError>>;
    /**
     ...
     * `PossibleErrorKeys<R>`
     */
    isError<R extends Response<unknown>, E extends LkErrorKey>(this: R, key: E extends PossibleErrorKeys<R> ? E : PossibleErrorKeys<R>): this is E extends PossibleErrorKeys<R> ? Response<LkErrorKeyToInterface[E]> : never;
}
/**
 * Input:
 ...
 */
export declare type ErrorResponses<T extends LkErrorKey> = T extends unknown ? Response<LkErrorKeyToInterface[T]> : Response<LkErrorKeyToInterface[T]>;
/**
 * Input:
 ...
 */
export declare type PossibleErrorKeys<R> = R extends {
    body: {
        key: infer ErrorKeys;
    };
} ? ErrorKeys : never;
...
export declare enum UnauthorizedErrorReason {
...
export declare type LkErrorKeyToInterface = {
