...
describe('StyleRules', () => {
  describe('getLegendForStyle()', () => {
    it('should return `red` for node:CITY', () => {
      const styles = new StyleRules([
        {type: SelectorType.ANY, itemType: 'CITY', style: {color: 'red'}, index: 0}
      ]);
      expect(
        StyleRules.getLegendForStyle('color' as StyleType, styles.color, [
    ...
    it('should return nothing', () => {
      ...
      expect(StyleRules.getLegendForStyle('color' as StyleType, styles.color, [])).to.eql([]);
    ...
    it('should return `200%` for node:CITY', () => {
      const styles = new StyleRules([
        {type: SelectorType.ANY, itemType: 'CITY', style: {size: '200%'}, index: 0}
      ]);
      expect(
        StyleRules.getLegendForStyle('size' as StyleType, styles.size, [
          {categories: ['CITY'], properties: {}, geo: {}, readAt: 0}
        ])
    ...
    it('should return nothing', () => {
      ...
      expect(StyleRules.getLegendForStyle('size' as StyleType, styles.size, [])).to.eql([]);
      ...
      const styles = new StyleRules([
        {
          type: SelectorType.ANY,
          itemType: 'CITY',
          style: {icon: {content: 'titi', font: 'arial'}},
          index: 0
        }
      ]);
      expect(
        StyleRules.getLegendForStyle('icon' as StyleType, styles.icon, [
          {categories: ['CITY'], properties: {}, geo: {}, readAt: 0}
        ])
    ...
    it('should return nothing', () => {
      ...
      expect(StyleRules.getLegendForStyle('icon' as StyleType, styles.icon, [])).to.eql([]);
    ...
    it('should return nothing for node:CITY color', () => {
      ...
      expect(
        StyleRules.getLegendForStyle('color' as StyleType.COLOR, styles.color, [
          {categories: ['CITY'], properties: {}, geo: {}, readAt: 0}
        ])
      ).to.eql([]);
    });
    ...
    it('should return nothing for node:CITY size', () => {
      ...
      expect(
        StyleRules.getLegendForStyle('size' as StyleType.SIZE, styles.size, [
          {categories: ['CITY'], properties: {}, geo: {}, readAt: 0}
        ])
      ).to.eql([]);
    });
    ...
    it('should return nothing for node:CITY icon', () => {
      ...
      expect(
        StyleRules.getLegendForStyle('icon' as StyleType.ICON, styles.icon, [
          {categories: ['CITY'], properties: {}, geo: {}, readAt: 0}
        ])
      ).to.eql([]);
    });
  ...
  describe('updateLegend()', () => {
    it('should add an item to legend', () => {
      ...
      expect(legend).to.eql([
        {label: 'top', value: 'test'},
        {label: 'tip', value: 'gnarf'}
      ]);
    });

    it('should update an item to legend', () => {
      const legend = [{label: 'top', value: 'tip'}];
      StyleRules.updateLegend(legend, {label: 'top', value: 'test'});
      expect(legend).to.eql([{label: 'top', value: 'test'}]);
    });
  });
  ...
  describe('getBy()', () => {
    it('should return an array of color rules', () => {
      expect(
        StyleRules.getBy('color' as StyleType, [
          {type: SelectorType.ANY, itemType: 'CITY', style: {color: 'red'}, index: 0},
    ...
    it('should return an array of size rules', () => {
      expect(
        StyleRules.getBy('size' as StyleType, [
          {type: SelectorType.ANY, itemType: 'CITY', style: {color: 'red'}, index: 0},
          {type: SelectorType.ANY, itemType: 'CITY', style: {size: '100%'}, index: 1}
        ]).length
      ).to.equal(1);
    ...
    it('should return an array of icon rules', () => {
      expect(
        StyleRules.getBy('icon' as StyleType, [
          {type: SelectorType.ANY, itemType: 'CITY', style: {color: 'red'}, index: 0},
          {
            type: SelectorType.ANY,
            itemType: 'CITY',
  ...
  describe('getRule()', () => {
    ...
    it('should return a icon rule', () => {
      ...
      ).to.eql({icon: {content: 'titi', font: 'arial'}});
    });
  ...
  describe('sanitizeValue', () => {
    ...
    it('should return "= {{range}}"', () => {
      ...
      expect(StyleRules.sanitizeValue(SelectorType.RANGE, {'<': 5, '>': 57})).to.equal(
        '< 5 and > 57'
      );
    });
  });
