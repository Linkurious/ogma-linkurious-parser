...
describe('StyleRule', () => {
    ...
    it('should return true', () => {
      expect(
        new StyleRule({
          ...
          style: {color: 'red'},
          index: 0
        }).canApplyTo({categories: ['CITY'], properties: {name: 'Paris'}, geo: {}, readAt: 0})
      ).to.be.true;
      ...
      expect(
        new StyleRule({
          ...
          style: {color: 'red'},
          index: 0
        }).canApplyTo({categories: ['CITY'], properties: {name: ''}, geo: {}, readAt: 0})
      ).to.be.true;
      ...
      expect(
        new StyleRule({
          ...
          style: {color: 'red'},
          index: 0
        }).canApplyTo({categories: ['CITY'], properties: {name: 'Dijon'}, geo: {}, readAt: 0})
      ).to.be.true;
    });
    ...
    it('should return false', () => {
      ...
      expect(
        new StyleRule({
          ...
          style: {color: 'red'},
          index: 0
        }).canApplyTo({categories: ['CITY'], properties: {name: 14}, geo: {}, readAt: 0})
      ).to.be.false;
    });
  });
  ...
  describe('StyleRule.checkNoValue', () => {
    it('should return true', () => {
      ...
      expect(
        StyleRule.checkNoValue({categories: ['CITY'], properties: {name: ''}, geo: {}, readAt: 0}, [
          'properties',
          'name'
        ])
      ).to.be.true;
    ...
    it('should return false', () => {
      expect(
        StyleRule.checkNoValue({categories: ['CITY'], properties: {name: 0}, geo: {}, readAt: 0}, [
          'properties',
          'name'
        ])
      ).to.be.false;
  ...
  describe('StyleRule.checkNan', () => {
    it('should return true', () => {
      expect(
        StyleRule.checkNan({categories: ['CITY'], properties: {name: 'toto'}, geo: {}, readAt: 0}, [
          'properties',
          'name'
        ])
      ).to.be.true;
    ...
    it('should return false', () => {
      expect(
        StyleRule.checkNan({categories: ['CITY'], properties: {name: '2'}, geo: {}, readAt: 0}, [
          'properties',
          'name'
        ])
      ).to.be.false;
      ...
      expect(
        StyleRule.checkNan({categories: ['CITY'], properties: {name: '2.6'}, geo: {}, readAt: 0}, [
          'properties',
          'name'
        ])
      ).to.be.false;
      ...
      expect(
        StyleRule.checkNan({categories: ['CITY'], properties: {name: 0}, geo: {}, readAt: 0}, [
          'properties',
          'name'
        ])
      ).to.be.false;
  ...
  describe('StyleRule.checkRange', () => {
    it('should return true', () => {
      expect(StyleRule.checkRange(0, {'<': 5})).to.be.true;

      expect(StyleRule.checkRange(2, {'<=': 5})).to.be.true;

      expect(StyleRule.checkRange(5, {'<=': 5})).to.be.true;

      expect(StyleRule.checkRange(2, {'>': 0})).to.be.true;

      expect(StyleRule.checkRange(0, {'>=': 0})).to.be.true;

      expect(StyleRule.checkRange(2, {'>': 0, '<=': 5})).to.be.true;

      expect(StyleRule.checkRange(5, {'>': 0, '<=': 5})).to.be.true;

      expect(StyleRule.checkRange(2, {'>=': 0, '<': 5})).to.be.true;

      expect(StyleRule.checkRange(0, {'>=': 0, '<': 5})).to.be.true;
    });

    it('should return false', () => {
      expect(StyleRule.checkRange(5, {'<': 5})).to.be.false;

      expect(StyleRule.checkRange(6, {'<': 5})).to.be.false;

      expect(StyleRule.checkRange(10, {'<=': 5})).to.be.false;

      expect(StyleRule.checkRange(0, {'>': 0})).to.be.false;

      expect(StyleRule.checkRange(-1, {'>=': 0})).to.be.false;

      expect(StyleRule.checkRange(10, {'>': 0, '<=': 5})).to.be.false;
